...
`,
    ...
    it('index-filename-repeat-is-not-an-error: same basename in different directories is ambiguity, not an error', () => {
      ...
      const nodeA: ModelNode = {
        ...
        type: 'document',
        kind: 'root',
        fields: { title: { value: 'Biz In A', editAttribution: { author: { kind: 'system', id: 'test' }, timestamp: '' } } },
        markers: {},
        relationships: [],
        rawSections: {},
      ...
      const nodeB: ModelNode = {
        ...
        type: 'document',
        kind: 'root',
        fields: { title: { value: 'Biz In B', editAttribution: { author: { kind: 'system', id: 'test' }, timestamp: '' } } },
        markers: {},
        relationships: [],
        rawSections: {},
