...
- [x] 1.1 Create test suite harness in [`scripts/export-console.test.mjs`](file:///d:/Users/lucas/Documents/GitHub/cogNNitive/scripts/export-console.test.mjs) with temporary workspace fixtures and execution helper <!-- id: 1.1 -->
...
- [x] 2.1 Implement source model content hashing (`computeSha256`) and slot injection of `meta.sha256` in [`scripts/export-console.mjs`](file:///d:/Users/lucas/Documents/GitHub/cogNNitive/scripts/export-console.mjs) <!-- id: 2.1 -->
...
- [x] 2.4 Verify all status inspection and metadata hashing tests pass in [`scripts/export-console.test.mjs`](file:///d:/Users/lucas/Documents/GitHub/cogNNitive/scripts/export-console.test.mjs) <!-- id: 2.4 -->
...
- [x] 4.1 Update Section 0 / 0a entry menu in [`skills/nn-innfo/SKILL.md`](file:///d:/Users/lucas/Documents/GitHub/cogNNitive/skills/nn-innfo/SKILL.md) to the canonical 7-option structure (`[a]`, `[b]`, `[c]`, `[d]`, `[x]`, `[w]`, `[y]`) <!-- id: 4.1 -->
...
- [x] 4.4 Align Core Rules and Activation Contract in [`skills/nn-innfo/SKILL.md`](file:///d:/Users/lucas/Documents/GitHub/cogNNitive/skills/nn-innfo/SKILL.md) to match remapped options <!-- id: 4.4 -->

## Phase 5: Manifest Governance & Documentation Cleanup

- [x] 5.1 Remove `pdf-to-innfo-dashboard` workflow references from [`docs/use/manifest.md`](file:///d:/Users/lucas/Documents/GitHub/cogNNitive/docs/use/manifest.md) and [`docs/use/manifest-next.md`](file:///d:/Users/lucas/Documents/GitHub/cogNNitive/docs/use/manifest-next.md) <!-- id: 5.1 -->
