# Spec: Template Freshness Diagnostic and UI Presentation
...
The web application ([`innfo-editor`](iNNfo/apps/innfo-editor)) MUST NOT attempt to download, overwrite, or mutate workspace files when a `TEMPLATE_CACHE_STALE` warning is encountered.
