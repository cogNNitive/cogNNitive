...
Every template MUST declare a procedures block even when empty. The creation wizard MUST announce an empty block instead of silently presenting a template with nothing executable.
