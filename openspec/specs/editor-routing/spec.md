...
Define client-side routing rules for `innfo-editor`, configuring legacy single-document routes (`/innfo-doc` and `/info-doc`) to redirect cleanly to the root home route (`/`) and removing deprecated standalone single-document views.
