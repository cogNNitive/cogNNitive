# Source Versioning Archive

## Purpose

Archive every previous normalized version of changed or deleted sources into `sources/archive/` to provide a first-class version history inside the workspace, tracking version chains in the lineage record without depending on git commits.
